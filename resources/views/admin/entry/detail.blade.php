    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <img src="{{ asset(($entry_note->picture_entry_note == '' || $entry_note->picture_entry_note == null) ? 'images/entry_notes_dummy.png' : asset('storage/nota_masuk/'.$entry_note->picture_entry_note) ) }}" alt="entry notes picture" class="mt-1 round dummy">
                        <div class="col ml-3">
